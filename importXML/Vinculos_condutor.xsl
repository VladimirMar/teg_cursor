		...
		<html>
			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="Vinculos_condutor">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="Empregador"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Data_de_OS', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Admissao', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="CPF_condutor"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
