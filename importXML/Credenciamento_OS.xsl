			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 2.38cm"/>
						<col style="WIDTH: 4.417cm"/>
						<col style="WIDTH: 3.015cm"/>
						<col style="WIDTH: 2.38cm"/>
						<col style="WIDTH: 3.28cm"/>
						<col style="WIDTH: 10.211cm"/>
						<col style="WIDTH: 3.359cm"/>
						<col style="WIDTH: 7.91cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 2.38cm"/>
						<col style="WIDTH: 2.38cm"/>
						<col style="TEXT-ALIGN: right; WIDTH: 4.603cm"/>
						<col style="WIDTH: 2.38cm"/>
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>DRE_ext</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>CPF_condutor</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>Situacao_de_OS</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Campo_de_Troca</strong>
								</div>
							</td>
							<td>
								<div align="center">
							...
							<td>
								<div align="center">
									<strong>Data_de_encerramento</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>Busca_veiculo</strong>
								</div>
							</td>
							<td>
								<div align="center">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="Credenciamento_OS">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Termo_de_adesao', '@', '', '', 202)"/>
								</td>
								<td>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Credenciado', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('DRE', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('DRE_ext', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('CPF_condutor', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('CRM', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('CPF_monitor', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Anotação', '@', '', '', 202)"/>
								</td>
								<td>
									<xsl:value-of select="Situacao_de_OS"/>
								</td>
								<td>
									<xsl:value-of select="Campo_de_Troca"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Preposto', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="Preposto_dias"/>
								</td>
								<td>
									<xsl:value-of select="Conexao"/>
								</td>
								<td>
									<xsl:value-of select="fx:FormatFromXSL('Data_de_encerramento', '', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="Busca_veiculo"/>
								</td>
								<td>
									<xsl:value-of select="CNPJ_CPF"/>
								</td>
								<td>
									<xsl:value-of select="Uniao_de_termos"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
