...
WITH parametro_multiplicador AS (
  ...
  SELECT
    v.codigo,
    ROUND(((fixo.valor_fixo * 12) + ((((v.cap_teg::numeric(14,2) * parametro_multiplicador.multiplicador) - (parametro_subtracao_a.subtracao_a * parametro_subtracao_b.subtracao_b)) * percap.valor_percap) * 12)), 2) AS novo_valor
  FROM veiculo v
